...
urlpatterns = [
    ...
    path('<int:article_id>/comments/', views.commentsAll, name='article_comments'),
    path('<int:article_id>/create_comment/', views.create_comment, name='create_comment'),
    path('<int:article_id>/<int:comment_id>/update_comment/', views.update_comment, name='update_comment'),
    ...
    path('<int:comment_id>/create_reply/', views.create_reply, name='create_reply'),
    path('<int:comment_id>/<int:reply_id>/update_reply/', views.update_reply, name='update_reply'),
