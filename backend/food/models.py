...
class Food(models.Model):
    ...
    SERVING_SIZE = models.IntegerField(null=True) #총내용량
    NUTR_CONT1 = models.FloatField(null=True) #열량(kcal)(1회제공량당)
    NUTR_CONT2 = models.FloatField(null=True) #탄수화물(g)(1회제공량당)
    NUTR_CONT3 = models.FloatField(null=True) #단백질(g)(1회제공량당)
    NUTR_CONT4 = models.FloatField(null=True) #지방(g)(1회제공량당)
    NUTR_CONT5 = models.FloatField(null=True) #당류(g)(1회제공량당)
    NUTR_CONT6 = models.FloatField(null=True) #나트륨(mg)(1회제공량당)
    NUTR_CONT7 = models.FloatField(null=True) #콜레스테롤(mg)(1회제공량당)
    NUTR_CONT8 = models.FloatField(null=True) #포화지방산(g)(1회제공량당)
    NUTR_CONT9 = models.FloatField(null=True) #트랜스지방(g)(1회제공량당)
